...
static constexpr const char kInitTimestampMap[] = "initTimestampMap";
/*
...
static constexpr const char kWamrRuntimeInitStart[] = "wamrRuntimeInitStart";
static constexpr const char kWamrRuntimeInitEnd[] = "wamrRuntimeInitEnd";
static constexpr const char kWamrLoadStart[] = "wamrLoadStart";
static constexpr const char kWamrLoadEnd[] = "wamrLoadEnd";
static constexpr const char kWamrInstantiateStart[] = "wamrInstantiateStart";
static constexpr const char kWamrInstantiateEnd[] = "wamrInstantiateEnd";
static constexpr const char kWamrCreateExecEnvStart[] =
    "wamrCreateExecEnvStart";
static constexpr const char kWamrCreateExecEnvEnd[] = "wamrCreateExecEnvEnd";
static constexpr const char kWamrThreadEnvStart[] = "wamrThreadEnvStart";
static constexpr const char kWamrThreadEnvEnd[] = "wamrThreadEnvEnd";
static constexpr const char kWamrEntryStart[] = "wamrEntryStart";
static constexpr const char kWamrEntryEnd[] = "wamrEntryEnd";
static constexpr const char kWamrFunctionCallStart[] = "wamrFunctionCallStart";
static constexpr const char kWamrFunctionCallEnd[] = "wamrFunctionCallEnd";
static constexpr const char kWamrHostCallStart[] = "wamrHostCallStart";
static constexpr const char kWamrHostCallEnd[] = "wamrHostCallEnd";
static constexpr const char kWamrCssApplyStart[] = "wamrCssApplyStart";
static constexpr const char kWamrCssApplyEnd[] = "wamrCssApplyEnd";
static constexpr const char kWamrFlushElementTreeStart[] =
    "wamrFlushElementTreeStart";
static constexpr const char kWamrFlushElementTreeEnd[] =
    "wamrFlushElementTreeEnd";
// ================== UNSPECIFIED ==================
