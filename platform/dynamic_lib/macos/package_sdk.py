...
try:
  ...
  icudtl = sys.argv[3]
  wrapper_header = os.path.normpath(
  ...
  print(f"wrapper_header: {wrapper_header}")
  ...
  if not os.path.exists(wrapper_header):
    raise Exception(f"wrapper_header: {wrapper_header} does not exist")
  ...
  zip_file.write(wrapper_header, 'include/capi/lynx_rust_capi.h')
