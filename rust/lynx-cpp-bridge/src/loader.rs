...
pub struct LoadedLibrary {
    ...
    pub lynx_view_reload_template: unsafe extern "C" fn(
        *mut lynx_view_t,
    ...
    pub lynx_template_data_mark_state:
...
impl LoadedLibrary {
    ...
    fn from_dynamic_library(library: DynamicLibrary) -> Result<Self> {
        ...
        Ok(Self {
            ...
            lynx_env_register_extension_module: load_symbol!(
                library,
            ...
            lynx_update_meta_set_update_data: load_symbol!(
                library,
                lynx_update_meta_set_update_data
            ),
            lynx_update_meta_set_global_props: load_symbol!(
                library,
            ...
            lynx_template_data_set_read_only: load_symbol!(
                library,
            ...
            lynx_windowless_renderer_run_task: load_symbol!(
                library,
            ...
            lynx_windowless_renderer_release: load_symbol!(
                library,
                lynx_windowless_renderer_release
            ),
            path,
            _library: library,
        })
